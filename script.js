...
var profileCache = {};
var ADMIN_HASH = '3a2b1c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2'; // nobu2025secure
...
// Новые функции: тех. перерыв и разработка
...
function toggleMaintenance() {
    ...
    if (maintenanceActive) {
        ...
        // Отправить Realtime-сигнал всем
        supabase.channel('system').send({
            type: 'broadcast',
            event: 'maintenance',
            payload: { active: true }
        });
...
// Realtime (добавлен канал system)
